              ...
              {viewType === 'schedule' && (
                <div className="flex items-center gap-2">
                   <button 
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] md:text-xs font-black transition-all border ${
                      showAllRoomsInSchedule ? 'bg-brand/10 border-brand text-brand' : 'bg-surface border-subtle text-secondary'
                    }`}
                   >
