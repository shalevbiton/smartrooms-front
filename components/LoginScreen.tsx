        ...
        <div className="px-8 pb-12">
          ...
          {activeTab === 'login' ? (
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <button type="submit" className="w-full bg-brand hover:bg-brand-hover text-white py-4 rounded-2xl font-black flex items-center justify-center gap-2 transition-all shadow-xl shadow-brand/20 hover:-translate-y-1 active:scale-95 mt-4"><LogIn size={20} />התחבר למערכת</button>
            </form>
          ) : (
