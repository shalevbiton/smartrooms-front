...
export const authApi = {
  getRegisterOptions: () => apiRequest('/auth/register-options', { method: 'POST' }),
  verifyRegister: (data: any) => apiRequest('/auth/register-verify', { method: 'POST', body: JSON.stringify(data) }),
  getLoginOptions: (personalId: string) => apiRequest('/auth/login-options', { method: 'POST', body: JSON.stringify({ personalId }) }),
